...
export interface ProdigeError {
    type: 'EXECUTION' | 'CHANNEL' | 'COOLDOWN' | 'GLOBAL_COOLDOWN' | 'PERMISSION' | 'BOT_PERMISSION' | 'OWNER_ONLY' | 'ROLE' | 'ARGUMENT_REQUIRED' | 'ARGUMENT_WRONG_TYPE' | 'NOT_IN_DM' | 'NOT_IN_GUILD';
    message: Message;
